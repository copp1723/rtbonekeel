/**
 * Extract Clean Content Tool
 * 
 * A tool that uses Python's trafilatura to extract clean text from webpages
 * by removing ads, navigation, and other non-content elements.
 */
import { spawn } from 'child_process';
import { join } from 'path';

// Define the interface for the tool's arguments
export interface ExtractCleanContentArgs {
  url: string;
}
